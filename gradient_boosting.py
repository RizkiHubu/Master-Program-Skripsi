...
def main():
    ...
    # Simpan model
    save_model(trained_model, 'model_kelulusan_gradient_boosting_no_balancing.joblib', le, 'label_encoder_gradient_boosting_no_balancing.joblib')
    
    # Contoh prediksi manual
    sample_data = [
        150,                                  # SKS TOTAL
        3.1, 3.2, 3.3, 3.4, 3.5,   # IP SEMESTER 1-7
        20, 22, 20, 21, 20,         # SKS TEMPUH SEMESTER 1-5
...
def run_with_hyperparameter_optimization():
    ...
    # Simpan model
    save_model(best_model, 'model_kelulusan_optimized.joblib', le, 'label_encoder_optimized.joblib')
